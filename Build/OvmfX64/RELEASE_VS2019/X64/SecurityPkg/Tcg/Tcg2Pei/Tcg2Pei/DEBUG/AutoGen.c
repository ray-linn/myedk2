...
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdTpm2InitializationPolicy = _PCD_VALUE_PcdTpm2InitializationPolicy;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdTpm2SelfTestPolicy = _PCD_VALUE_PcdTpm2SelfTestPolicy;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT8 _gPcd_FixedAtBuild_PcdTpm2ScrtmPolicy = _PCD_VALUE_PcdTpm2ScrtmPolicy;
