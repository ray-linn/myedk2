...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xF12F698A, 0xE506, 0x4A1B, {0xB3, 0x2E, 0x69, 0x20, 0xE5, 0x5D, 0xA1, 0xC4}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TpmMmioSevDecryptPei";
...
// PPIs
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gOvmfTpmMmioAccessiblePpiGuid = {0x35c84ff2, 0x7bfe, 0x453d, {0x84, 0x5f, 0x68, 0x3a, 0x49, 0x2c, 0xf7, 0xb7}};
...
{
  return TpmMmioSevDecryptPeimEntryPoint (FileHandle, PeiServices);
}
