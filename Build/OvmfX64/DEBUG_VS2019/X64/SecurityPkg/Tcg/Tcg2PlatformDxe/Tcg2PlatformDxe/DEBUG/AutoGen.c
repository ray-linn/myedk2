...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x5CAB08D5, 0xAD8F, 0x4d8b, {0xB8, 0x28, 0xD1, 0x7A, 0x8D, 0x9F, 0xE9, 0x77}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "Tcg2PlatformDxe";
...
{
  return Tcg2PlatformDxeEntryPoint (ImageHandle, SystemTable);
}
